export const SteeringWheel1 = () =>
(<svg className="steeringWheel1" viewBox="0 0 7.613667 3.2605522" version="1.1" id="svg1">
   <g id="g9" transform="matrix(0.03527778,0,0,-0.03527778,-59.294171,143.53206)">
      <path
